...
// -------------------------------------------------
    ...
    public static final String mBroadcastArrayListAction = "com.truiton.broadcast.arraylist6";
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(mBroadcastArrayListAction)) {
                //dictPercorso = Salva.getPercorsoReceive(6);
                dictOb = Salva.getObiettivoReceive(6);
                dictPre = Salva.getPremioReceive(6);
                dictOperators = Salva.getOperatoriReceive(6);
                ConvertPercorsoToGestureMapDictionary(dictPercorso);
                Intent stopIntent = new Intent(myContext ,
                        BroadcastService.class);
                myContext.stopService(stopIntent);
                pd.dismiss();
            }
