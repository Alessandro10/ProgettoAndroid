...
public class Expandable {
    ...
    public void creaExpandableListView(int color , int utilita , ExpandableListView expListView, final Context myContext /*,List<String> titoli*/,
                                       Dictionary<String , List<Integer>> dicts/*Dictionary<String, Dictionary<String, String>> dicts*/ , Dictionary<Integer , Percorsi.Percorso> dictPercorso ,
                                       ...
                                       Dictionary<String , Percorsi.Operators> dictOperators)
    {
        ...
        prepareListData(color , utilita/*, titoli*/, dicts, expListView, myContext , dictPercorso , dictPre , dictOb , dictOperators);
    }
            ...
            public void run() {
                ...
                try {
                    ...
                    if(statusLine.getStatusCode() == 200)
                    {
                        ...
                        openPremio(namePremio , validation_code);
                    }
                    else
                    {
                        String messaggio = "";
    ...
    public void openPremio(String nome , String codice)
    {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(mContext);
    ...
    private void ese(int color , final int utilita , List<String> titoli/*String[] titoli*/ ,
        ...
        //List<String>[] primo = new ArrayList[titoli.length + 1];
