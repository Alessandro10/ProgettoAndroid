    ...
    public Dictionary<String , List<Integer>> DizionarioNelleVicinanze(Dictionary<Integer, Percorsi.Percorso> dictPercorso)
    {
        ...
        if(expListView != null) {
            ...
            b.creaExpandableListView(2, 0, expListView, myContext , dic, dictPercorso, dictPre, dictOb, dictOperators);
                ...
                inizializzaDict(1, Ob_string);
                inizializzaDict(2, Pr_string);
...
//String url = "http://daniele.cortesi2.web.cs.unibo.it/wsgi/routes/44.5461898/11.1927492/16000";
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        button_obbiettivo.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN) {
                    button_obbiettivo.setBackgroundDrawable( getResources().getDrawable(R.drawable.button_green_selected) );
                }
                if(event.getAction() == MotionEvent.ACTION_UP ||event.getAction() == MotionEvent.ACTION_MOVE ) {
                    button_obbiettivo.setBackgroundDrawable( getResources().getDrawable(R.drawable.button_green));
                }
        ...
        cerca.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN) {
                    cerca.setBackgroundDrawable( getResources().getDrawable(R.drawable.button_green_selected) );
                    generaColore(coloreprecedente);
                }
                if(event.getAction() == MotionEvent.ACTION_UP ||event.getAction() == MotionEvent.ACTION_MOVE ) {
                    cerca.setBackgroundDrawable( getResources().getDrawable(R.drawable.button_green));
                }
        ...
        premio.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN) {
                    premio.setBackgroundDrawable( getResources().getDrawable(R.drawable.button_green_selected) );
                }
                if(event.getAction() == MotionEvent.ACTION_UP ||event.getAction() == MotionEvent.ACTION_MOVE ) {
                    premio.setBackgroundDrawable( getResources().getDrawable(R.drawable.button_green));
                }
                return false;
            }
        });
        ...
        obiettivo.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN) {
                    obiettivo.setBackgroundDrawable( getResources().getDrawable(R.drawable.button_green_selected) );
                }
                if(event.getAction() == MotionEvent.ACTION_UP ||event.getAction() == MotionEvent.ACTION_MOVE ) {
                    obiettivo.setBackgroundDrawable( getResources().getDrawable(R.drawable.button_green));
                }
                return false;
            }
        });
        ...
        select3.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if(event.getAction() == MotionEvent.ACTION_DOWN) {
                    select3.setBackgroundDrawable( getResources().getDrawable(R.drawable.button_green_selected) );
                }
                if(event.getAction() == MotionEvent.ACTION_UP ||event.getAction() == MotionEvent.ACTION_MOVE ) {
                    select3.setBackgroundDrawable( getResources().getDrawable(R.drawable.button_green));
                }
                return false;
            }
        });
        ...
        distanza.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN) {
                    distanza.setBackgroundDrawable( getResources().getDrawable(R.drawable.button_green_selected) );
                }
                if(event.getAction() == MotionEvent.ACTION_UP ||event.getAction() == MotionEvent.ACTION_MOVE ) {
                    distanza.setBackgroundDrawable( getResources().getDrawable(R.drawable.button_green));
                }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.activity_ricerca, null, false);
        return v;
    }
