...
public class Obiettivo extends Fragment {

    boolean click = false;
    List<String> listapreferitiPercorsi = new ArrayList<String>();
    List<String> listapreferitiPremi = new ArrayList<String>();
    public ProgressDialog pd;
    public static final String mBroadcastArrayListAction = "com.truiton.broadcast.arraylist4";
...
// -------------------------------------------------
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(mBroadcastArrayListAction)) {
                dictPercorso = Salva.getPercorsoReceive(4);
                dictOb = Salva.getObiettivoReceive(4);
                dictPre = Salva.getPremioReceive(4);
                dictOperators = Salva.getOperatoriReceive(4);
                tipiPercorsi = Salva.getTipiPercorsoReceive(4);
                tipiPremi = Salva.getTipiPremiReceive(4);
                DizionarioObiettivi(dictPercorso);
    ...
    public Dictionary<String , List<Integer>> DizionarioObiettivi(Dictionary<Integer, Percorsi.Percorso> dictPercorso)
    {
        Dictionary<Integer, Percorsi.Percorso> dictPercorsoIniziati = getPercorsiSvolti();
        ...
        if(expListView != null) {
            ...
            for (Enumeration e = dictPercorsoIniziati.keys(); e.hasMoreElements(); ) {
                int idP = (int)e.nextElement();
                if(!cercaIntList(list , idP)) {
                    list.add(idP);
                }
            }
            dic.put("Percorsi Iniziati" , list);
    ...
    private Dictionary<String, List<Integer>> filtraPerObiettivo(Dictionary<String, List<Integer>> dictD , String text) {
        Dictionary<String, List<Integer>> dic = new Hashtable<String, List<Integer>>();
...
//String url = "http://daniele.cortesi2.web.cs.unibo.it/wsgi/routes/44.5461898/11.1927492/16000";
        ...
        cerca.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dic = DizionarioObiettivi(dictPercorso);

                dic = filtraPerObiettivo(dic, text);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_obiettivo, null, false);
        return v;
    }
